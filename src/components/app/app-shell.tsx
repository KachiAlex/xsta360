...
export async function AppShell({
  ...
  return (
    <div className="flex min-h-screen md:h-screen md:overflow-hidden">
      ...
      />
      <div className="app-main flex-1 flex flex-col min-w-0 md:overflow-hidden">
        {showTrialBanner && (
          <div className="bg-amber/10 border-b border-amber/20 px-4 py-2 text-center shrink-0">
        ...
        <div className="flex-1 overflow-y-auto min-h-0 md:overflow-y-auto">{children}</div>
        <Footer />
      </div>
